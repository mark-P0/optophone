...
def preprocess(
    ...
    image = preprocessing.correct_orientation(
        image)
    return image


def postprocess(text: str) -> str:
    text = postprocessing.remove_blank_lines(
        text)
    return text
...
def image_to_text(
    ...
    config_map = {
        "tessedit_char_whitelist": '"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ,.?!\'-()/1234567890"',  # noqa: E501
